...
const Hero3D: React.FC = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("WebGL Fallback active.", e);
      setWebglError(true);
      return;
    }
  ...
  return (
    <div className="relative w-full h-[700px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-600 via-emerald-400 to-rose-300 animate-gradient">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <p className="text-xl md:text-3xl text-emerald-50 font-medium mb-12 drop-shadow-md max-w-2xl mx-auto leading-relaxed text-center">
